...
// What is the DOM tree? Document Object Model connects the web page to the script. BAsed on hierarchical tree structure that is generated by the web browser.
// What is a node in the DOM? A point or object inside the Document Object Model; individual nodes can be structural elements, the plain text, the attributes, and even the comments.
// What is the difference between a parent and a child node? Parent nodes are a node that sits directly above and contains other nodes, like child nodes.
// What is a sibling node? Node that shares the exact same parent node as another node on the same hierarchical level like li's inside ol tags.
